...
export const libs: Lib[] = [
	{
		...
		locations_rankings_clan_builderbase: 'Yes',
		locations_rankings_player_builderbase: 'Yes',
		locations: 'Yes',
		location_info: 'Yes',
		goldpass: 'Yes',
		labels_player: 'Yes',
	...
	},
	{
		...
		locations_rankings_clan_builderbase: 'No',
		locations_rankings_player_builderbase: 'No',
		locations: 'No',
		location_info: 'No',
		goldpass: 'No',
		labels_player: 'No',
	...
	{
		name: 'coc.rs',
		url: 'https://github.com/amaanq/coc.rs',
		language: 'Rust',
		loginWithToken: 'no',
		loginWithEmail: 'Yes',
		dynamicIP: 'Yes',
	...
	},
	{
		...
		url: 'https://github.com/expeehaa/clash_of_clans_api',
		language: 'Ruby',
		loginWithToken: 'Yes',
		loginWithEmail: 'Yes',
		dynamicIP: 'No',
